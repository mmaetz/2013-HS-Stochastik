...
\begin{align*}
	...
	\intertext{Offensichtlich ist die kumulative Verteilungsfunktion eine Troppenfunktion mit Sprüngen an den Stellen $x\in W$ mit Sprunghöhen $p(x)$, also nicht stetig. Ferner gilt}
	Q(B)&=\sum_{x\in B}^{}p(x).
\end{align*}
