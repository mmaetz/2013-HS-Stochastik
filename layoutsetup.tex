...
\makechapterstyle{test}{
	...
	\colorlet{rulecolor}{chapterlinecolor}
	\renewcommand{\chapterheadstart}{\rule{\columnwidth}{11pt}%\vspace{-1pt}}
}
	...
	\renewcommand{\afterchaptertitle}{\par\nobreak\vspace{-10pt}\rule{\columnwidth}{2pt}\vskip\afterchapskip}
}
...
{-2\baselineskip}{8pt}
	...
	\textcolor{sectionlinecolor}{\hrule depth 8pt}
	%
