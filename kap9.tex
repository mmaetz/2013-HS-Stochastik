...
\begin{tabular}[]{cc|c|c|}
	...
	\cline{3-4}
	\multirow{4}{*}{\rotatebox[]{90}{Wahrheit\quad}}\!\!\!&\multirow{2}{*}{$H_0$}\!\!&kein Fehler&Fehler 1. Art\\
	&&$\!\begin{aligned}p&=1-\alpha\\&=P_{H_0}(X\not\in V) \end{aligned}\!$&$\!\begin{aligned}p&=\alpha\\&=P_{H_0}(X\in V) \end{aligned}\!$\\
	\cline{3-4}
	&\multirow{2}{*}{$H_A$}\!\!&Fehler 2. Art&kein Fehler\\
	&&$\!\begin{aligned}p&=\beta\\&=P_{H_A}(X\not\in V) \end{aligned}\!$&$\!\begin{aligned}p&=1-\beta\\&=P_{H_A}(X\in V) \end{aligned}\!$\\
	\cline{3-4}
\end{tabular}
